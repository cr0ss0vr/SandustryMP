		...
		create(author) {
			...
			const STRINGS = {
				en: {
					...
					lb_worlds: "WORLDS", lb_saves: "SAVES", lb_save_count: (n) => n + (n === 1 ? " save" : " saves"),
				...
				pl: {
					...
					lb_worlds: "ŚWIATY", lb_saves: "ZAPISY", lb_save_count: (n) => n + (n === 1 ? " zapis" : " zapisów"),
				...
				zh: {
					...
					chat_left: (n) => n + " 离开了",
					lb_nick: "你的昵称",
					lb_worlds: "世界", lb_saves: "存档", lb_save_count: (n) => n + " 个存档",
